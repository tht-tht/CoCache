...
const std::vector<std::pair<Tickers, std::string>> TickersNameMap = {
    ...
    {FILTER_CACHE_HIT,"rocksdb.filter_cache_hit.count"},
    {FILTER_CACHE_MISS,"rocksdb.filter_cache_miss.count"},
    {INDEX_CACHE_HIT,"rocksdb.index_cache_hit.count"},
    {INDEX_CACHE_MISS,"rocksdb.index_cache_miss.count"},
    {DATA_CACHE_HIT,"rocksdb.data_cache_hit.count"},
    {DATA_CACHE_MISS,"rocksdb.data_cache_miss.count"},
};
